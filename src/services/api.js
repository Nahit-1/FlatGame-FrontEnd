...
const imagesUrl = corsWorkAround + baseUrl + '/covers'
const imageFields = 'alpha_channel,animated,game,height,image_id,url,width'
const authKey = '5dab8c9043eaad8423d6bacefd5627e2'

const get = (url, fields)  => {
    return fetch( url, {
...
const getGames = () => get(gamesUrl, allFields)
const getGamesImages = () => get(imagesUrl, imageFields)


export default { getGames, getGamesImages }